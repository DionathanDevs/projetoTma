...
class TorreAnenometrica
{
    ...
    public function add($name, $datalog_deviceid, $datalog_number, $datalog_model, $datalog_software, $datalog_login, $datalog_password, $datalog_ip, $datalog_mask, $datalog_gateway, $rack_panel, $rack_sw, $rack_sw_port) {
